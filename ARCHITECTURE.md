# CLAUDEMAX v0.6.1 — Complete Architecture
...
```
              ...
              │     rational-router-apex.mjs (RIPPLE) │
              ├──────────────────────────────────────┤
              │                                      │
              │  ┌────────┐ ┌──────────┐ ┌────────┐ │
              │  │UPDATE  │ │ PROMPT   │ │ ROUTE  │ │
              ...
              │  [CLAUDEMAX UPDATE]     (if outdated) │
              │  [CLAUDEMAX PROMPT-ENGINE] (enriched) │
              │  [CLAUDEMAX DISPLAY]    (loading bar) │
              │  [CLAUDEMAX DIRECTIVE]  (hidden)      │
              └──────────────────┬───────────────────┘
                                 │
                                 ▼
              ┌──────────────────────────────────────┐
...
├── current-task.json           Current task from Ripple
...
| UserPromptSubmit | rational-router-apex (Ripple) | Update check + prompt engine + route + enrich |
