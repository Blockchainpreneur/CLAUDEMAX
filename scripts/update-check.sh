#!/usr/bin/env bash
# claudemax-update-check — periodic version check, modeled after gstack.
#
...
CM_DIR="${CM_DIR:-$HOME/claudemax}"
STATE_DIR="$HOME/.claudemax"
CACHE_FILE="$STATE_DIR/last-update-check"
SNOOZE_FILE="$STATE_DIR/update-snoozed"
VERSION_FILE="$CM_DIR/VERSION"
REMOTE_URL="https://raw.githubusercontent.com/Blockchainpreneur/CLAUDEMAX/main/VERSION"
