#!/usr/bin/env python3
"""
CLAUDEMAX LightRAG CLI — Local vector search for session memory.
...
def main():
    parser = argparse.ArgumentParser(description="CLAUDEMAX LightRAG CLI")
    parser.add_argument("command", choices=["ingest", "query", "status"])
    parser.add_argument("--workspace", default=os.path.expanduser("~/.claudemax/lightrag-workspace"))
